...
.v02-edit-transcript section{width:min(500px,100%);height:min(310px,calc(50vh - var(--v02-editor-top)));max-height:calc(50vh - var(--v02-editor-top));height:min(310px,calc(50dvh - var(--v02-editor-top)));max-height:calc(50dvh - var(--v02-editor-top));background:white;padding:clamp(10px,2.6dvh,22px);border-radius:18px;display:grid;grid-template-rows:auto minmax(0,1fr) auto;gap:clamp(6px,1.65dvh,14px);overflow-y:auto}.v02-edit-transcript textarea{width:100%;height:140px;min-height:0;max-height:100%;padding:12px;font:inherit;overflow-y:auto}.v02-edit-transcript nav{display:flex;justify-content:flex-end;gap:10px}
