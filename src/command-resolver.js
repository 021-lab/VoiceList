...
const FRAMES = [
  ...
  { command: 'setStatus', status: 'Done', slot: 'none', ctx: 'required', target: false,
    forms: ['готово', 'готова', 'сделано', 'выполнено', 'закрой', 'закрыть',
            'заверши', 'завершить', 'это готово', 'это сделано', 'сделай готово', 'сделай это готово', 'сделай сделано', 'сделай это сделано'] },
  ...
  { command: 'setStatus', status: 'Pause', slot: 'none', ctx: 'required', target: false,
    forms: ['отложи', 'отложить', 'это на паузу', 'это паузу', 'это пауза', 'это потом', 'сделай паузу', 'сделай это пауза', 'сделай на паузу', 'сделай это на паузу'] },

  { command: 'setStatus', status: 'Archive', slot: 'none', ctx: 'required', target: false,
    forms: ['удали', 'удалить', 'убери', 'убрать', 'заархивируй',
            'это в архив', 'это архив', 'сделай архив', 'сделай это архив', 'сделай в архив'] },

  { command: 'setStatus', status: 'Open', slot: 'none', ctx: 'required', target: false,
    forms: ['сними', 'сними фокус', 'сними паузу', 'возобнови',
            'это в работу', 'это работу', 'это открыто', 'сделай открыто', 'сделай это открыто', 'сделай в работу', 'сделай это в работу'] },

  { command: 'setStatus', status: 'Info', slot: 'none', ctx: 'required', target: false,
    forms: ['это информация', 'это инфо', 'сделай информация', 'сделай это информация', 'сделай инфо', 'сделай это инфо'] },
